...
Public Class frmReportPCR
    ...
    Sub ExportExcel()
        ...
        Dim excelLocation As String = "C:\ExportLab\" & "report_center_ATK_FIA_PCR_" & pdate & ".xlsx"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        'https://stackoverflow.com/questions/680199/how-to-export-datagridview-to-excel-using-vb-net/37381927
...
LEFT OUTER JOIN labresult on labresult.ln=lbbk.ln and labresult.lab_code_local='SAR'
WHERE DATE(ovst.vstdttm) ='" & pStr & "' and TIME(ovst.vstdttm) BETWEEN '" & TextBox1.Text & "' and '" & TextBox2.Text & "'
and lbbk.labcode in('634', '635', '636','904') and lbbk.accept = '1'
GROUP BY ovst.vn
UNION
SELECT 
concat('\'',DATE_FORMAT(ovst.vstdttm,'%Y/%m/%d ')) as 'ORDERDATE',
...
LEFT OUTER JOIN labresult on labresult.ln=lbbk.ln and labresult.lab_code_local='SAR'
WHERE DATE(ovst.vstdttm) ='" & pStr & "' and TIME(ovst.vstdttm) BETWEEN '" & TextBox1.Text & "' and '" & TextBox2.Text & "'
and lbbk.labcode ='863' and lbbk.accept = '1'
GROUP BY ovst.vn
UNION
SELECT 
concat('\'',DATE_FORMAT(ovst.vstdttm,'%Y/%m/%d ')) as 'ORDERDATE',
...
WHERE DATE(ovst.vstdttm) ='" & pStr & "' and TIME(ovst.vstdttm) BETWEEN '" & TextBox1.Text & "' and '" & TextBox2.Text & "'
and lbbk.labcode ='887' and lbbk.accept = '1'
GROUP BY ovst.vn
")
    ...
    Private Sub frmReportPCR_Load(sender As Object, e As EventArgs) Handles MyBase.Load

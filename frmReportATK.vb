...
Public Class frmReportATK
    Private _curCulture As System.Globalization.CultureInfo
    Private Sub frmReportATK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub ExportExcel()
        ...
        Dim excelLocation As String = "C:\ExportLab\" & "report_center_ATK_" & pdate & ".xlsx"

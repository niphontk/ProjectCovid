...
Public Class frmAtk
    ...
    Sub ExportExcel()
        ...
        Dim excelLocation As String = "C:\ExportVaccince\" & "report_ATK" & pdate & ".xlsx"
...
SELECT
    ...
    Private Sub frmAtk_Load(sender As Object, e As EventArgs) Handles MyBase.Load
